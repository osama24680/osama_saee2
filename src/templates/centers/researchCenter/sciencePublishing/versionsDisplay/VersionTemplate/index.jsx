...
const VersionTemplate = ({ parentTitle, mainTitle, pageData }) => {
  return (
    <Layout
    ...
    >
      <Helmet>
        <title>{`${pageData?.title} - ${mainTitle}`}</title>
      </Helmet>

      <div className={styles.VersionTemplate}>
        <Container>
              ...
              <Col lg={12}>
                {pageData ? (
                  <div className='singleBlog mb-4'>
                    ...
                    <CurvyLink
                      href={pageData.objective[v.storeURL] || ''}
                      disabled={!pageData.objective[v.storeURL]}
                    >
                      {t.btns.buy}
                    </CurvyLink>
                  </div>
